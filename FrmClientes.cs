...
namespace AutomotrizApp
{
    ...
    {
        private string servidor = Properties.Resources.servidor; //@"Data Source=V3-472P\SQLEXPRESS;Initial Catalog=db_automotriz;Integrated Security=True";

        public FrmClientes()
        {
            InitializeComponent();
            rbtnConCompra.Checked = true;
        }
